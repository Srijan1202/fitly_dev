export async function POST(req: Request) {
  ...
  try {
    ...
    const response = await fetch(
      `https://asos2.p.rapidapi.com/products/v2/list?q=${encodeURIComponent(query)}&store=US&lang=en-US&limit=4&country=US&currency=USD&sizeSchema=US&sort=freshness`,
      {
        headers: {
